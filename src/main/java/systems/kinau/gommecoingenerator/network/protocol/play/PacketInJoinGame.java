...
public class PacketInJoinGame extends Packet {
    ...
    public void read(ByteArrayDataInputWrapper in, NetworkHandler networkHandler, int length, int protocolId) {
        ...
        GommeCoinGenerator.getInstance().getEventManager().callEvent(new JoinGameEvent(eid, gamemode, dimension, difficulty, maxPlayers, viewDistance, levelType, reducedDebugInfo));
    }
}
