...
import systems.kinau.gommecoingenerator.event.play.SpawnObjectEvent;
...
public class PacketInSpawnObject extends Packet {
    ...
    public void read(ByteArrayDataInputWrapper in, NetworkHandler networkHandler, int length, int protocolId) {
        ...
        GommeCoinGenerator.getInstance().getEventManager().callEvent(new SpawnObjectEvent(getId(), getType()));
    }
}
